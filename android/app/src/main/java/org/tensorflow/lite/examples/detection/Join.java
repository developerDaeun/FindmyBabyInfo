...
public class Join extends AppCompatActivity {
    ...
    private Button join, back, privacy_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(strID.equals("")){   //아이디 미 입력
                    ...
                    if (!strNum.matches("^01(?:0|1|[6-9])(?:\\d{3}|\\d{4})\\d{4}$")) {
                        ...
                        if(!radio_button.isChecked()){
                            Toast.makeText(getApplicationContext(),"개인정보 처리 방침에 동의해주세요", Toast.LENGTH_SHORT).show();
                        }//라디오버튼 체크되지 않은 경우
                        else {
        ...
        privacy_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Join.this, Privacy.class);
                startActivity(intent);
            }
        });//개인정보 처리 방침 보기 버튼 누른 경우
    }
    ...
    private void findById(){
        ...
        privacy_button=(Button)findViewById(R.id.privacy_button);
    }
